...
//    /   - data: message to sign
    ...
    public static func HMACSHA512(key: Data, data: Data) -> Data {
        return CryptoConflux.HMACSHA512(key: key, data: data)
    }
    ...
    public static func PBKDF2SHA512(_ password: Data, salt: Data) -> Data {
        return CryptoConflux.PBKDF2SHA512(password, salt: salt)
    }
    ...
    public static func hash160(_ data: Data) -> Data {
        return CryptoConflux.hash160(data)
    }
    ...
    public static func doubleSHA256(_ data: Data) -> Data {
        return CryptoConflux.doubleSHA256(data)
    }
    ...
    public static func hashSHA3_256(_ data: Data) -> Data {
        return CryptoConflux.hashSHA3_256(data)
    }
    ...
    public static func generatePublicKey(data: Data, compressed: Bool) -> Data {
        return CryptoConflux.generatePublicKey(data: data, compressed: compressed)
    }
    ...
    /// - Throws: ConfluxError.failedToSign in case private key was invalid
    public static func sign(_ hash: Data, privateKey: Data) throws -> Data {
        return try CryptoConflux.sign(hash, privateKey: privateKey)
    }
    ...
    public static func isValid(signature: Data, of hash: Data, publicKey: Data, compressed: Bool) -> Bool {
        return CryptoConflux.isValid(signature: signature, of: hash, publicKey: publicKey, compressed: compressed)
    }
    ...
    public static func publicKey(signature: Data, of hash: Data, compressed: Bool) -> Data? {
        return CryptoConflux.publicKey(signature: signature, of: hash, compressed: compressed)
    }
}
